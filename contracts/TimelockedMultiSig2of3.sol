...
//
// ADDITIONAL WARNING: This contract is **NOT** ETH tokens compatible.
// ETH sent to this contract will be lost forever.
//
// ERROR CODES:
//
// 1: Invalid Owner Address. You must provide three distinct addresses.
//    None of the provided addresses may be 0x00.
// 2: Invalid Destination. You may not send ERC20 to this contract's address.
// 3: Insufficient Balance. You have tried to send more ERC20 that this
...
contract TimelockedMultiSig2of3 {
    ...
    event Spent(address tokenContract, address to, uint amount);

    // Instantiate a new Multisig 2 of 3 contract owned by the
    // three given addresses
    constructor(address owner1, address owner2, address owner3, uint _unlockDate) public {
    ...
    {
        bytes32 message = _messageToRecover(tokenContract, destination, value);
